...
public class Loteria {
    ...
    public static void main(String[] args) {
        ...
        Bilhete SimuladorLoteria = new Bilhete();
        int tamanhoBilhete = SimuladorLoteria.getTamanhoBilhete();
        int[] numerosEscolhidos = new int[tamanhoBilhete];
        ...
        SimuladorLoteria.setNumerosEscolhidos(numerosEscolhidos);
        SimuladorLoteria.realizarSorteio();
        SimuladorLoteria.exibirResultado();
